...
/tool netwatch add host=192.168.5.3 interval=00:00:09 up-script="/ip firewall filter disable [find comment=default-fw]";" down-script="/ip firewall filter enable [find comment=default-fw]";"
